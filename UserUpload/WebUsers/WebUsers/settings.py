"""
Django settings for WebUsers project.
...
SECRET_KEY = '3-u_0bflnca@-)*(u=@$q9+7=cl6o8leg58k!qztabfydasc&6'
...
WSGI_APPLICATION = 'WebUsers.wsgi.application'
